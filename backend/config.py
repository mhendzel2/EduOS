...
class Settings:
    ...
    TURBOQUANT_DEFAULT_ENABLED: bool = _env_bool("TURBOQUANT_DEFAULT_ENABLED", False)
    TURBOQUANT_COMPRESSION_MODEL: str = os.getenv("TURBOQUANT_COMPRESSION_MODEL", "gemini/gemini-2.5-flash")
    TURBOQUANT_MIN_CHARS: int = int(os.getenv("TURBOQUANT_MIN_CHARS", "800"))
    ...
    MEMORY_COMPACTION_TOKEN_THRESHOLD: int = int(os.getenv("MEMORY_COMPACTION_TOKEN_THRESHOLD", "4000"))
    MEMORY_COMPACTION_FACT_RETENTION: int = int(os.getenv("MEMORY_COMPACTION_FACT_RETENTION", "5"))
    MEMORY_COMPACTION_SUMMARY_KEEP_CHARS: int = int(os.getenv("MEMORY_COMPACTION_SUMMARY_KEEP_CHARS", "2000"))
