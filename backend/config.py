...
@dataclass
class Settings:
    APP_NAME: str = os.getenv("APP_NAME", "StudioOS")
    ...
    OLLAMA_BOOTSTRAP_STATUS_FILE: str = os.getenv("OLLAMA_BOOTSTRAP_STATUS_FILE", "/tmp/studioos-ollama-bootstrap-status.json")
    OLLAMA_BOOTSTRAP_LOG_FILE: str = os.getenv("OLLAMA_BOOTSTRAP_LOG_FILE", "/tmp/studioos-ollama-bootstrap.log")
    ...
    DATABASE_URL: str = _resolve_database_url(os.getenv("DATABASE_URL", "sqlite:///./studio_os.db"))
